...
Deno.test("common tags", () => {
  ...
  testCommonTag("tg-spoiler", "spoiler"); 
...
Deno.test("parseAttributes", () => {
  ...
  assertEquals(parseAttributes_("href='1'"), { href: "1" });
  assertEquals(parseAttributes_('href="https:
...
Deno.test("td", () => {
  ...
  assertEquals(parseHtml("<a href=telegram.org>\t</a>"), ["\t", [{ type: "textLink", offset: 0, length: 1, url: "http:
  assertEquals(parseHtml("<a href=telegram.org>\r</a>"), ["\r", [{ type: "textLink", offset: 0, length: 1, url: "http:
  assertEquals(parseHtml("<a href=telegram.org>\n</a>"), ["\n", [{ type: "textLink", offset: 0, length: 1, url: "http:
  ...
  assertEquals(parseHtml("<a>telegram.org</a>"), ["telegram.org", [{ type: "textLink", offset: 0, length: 12, url: "http:
  assertEquals(parseHtml("<a>https:
