    ...
    if (botToken) {
      ...
      if (phone) {
        ...
        params = {
          ...
          password: password || ((hint: string | null) => Promise.reject(new InputError(`PASSWORD environment variable is required. Password hint: ${hint || "none"}`))),
        };
      } else {
